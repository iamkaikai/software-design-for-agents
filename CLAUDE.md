...
- `profiles/` — Task-specific rule sets (review, implement, refactor, debug). Each profile references rules in priority order.
- `examples/` — Drop-in integration files (AGENTS.md, CLAUDE.md, GEMINI.md) with synced content.
...
- The three example files (AGENTS.md, CLAUDE.md, GEMINI.md) must always have identical content. When updating one, update all three.
